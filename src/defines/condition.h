...
#define INIT_TASK_STACK_RGB 1000
#define INIT_TASK_STACK_DUMP_BATTERY 2000
#if DEBUG
// Debug is enabled, task stacks increased. If it crashes, make sure to enable heap debugging!
#define TASK_STACK_BUTTON INIT_TASK_STACK_BUTTON
#define TASK_STACK_VIBRATION INIT_TASK_STACK_VIBRATION + 2500
#define TASK_STACK_WIFI INIT_TASK_STACK_WIFI
#define TASK_STACK_SCOM INIT_TASK_STACK_SCOM
#define TASK_STACK_WATCHDOG INIT_TASK_STACK_WATCHDOG + 2500
#define TASK_STACK_RGB INIT_TASK_STACK_RGB
#define TASK_STACK_DUMP_BATTERY INIT_TASK_STACK_DUMP_BATTERY
#else
#define TASK_STACK_BUTTON INIT_TASK_STACK_BUTTON
#define TASK_STACK_VIBRATION INIT_TASK_STACK_VIBRATION
#define TASK_STACK_WIFI INIT_TASK_STACK_WIFI
#define TASK_STACK_SCOM INIT_TASK_STACK_SCOM
#define TASK_STACK_WATCHDOG INIT_TASK_STACK_WATCHDOG
#define TASK_STACK_RGB INIT_TASK_STACK_RGB
#define TASK_STACK_DUMP_BATTERY INIT_TASK_STACK_DUMP_BATTERY
#endif
